...
rz(pi*0.5) q[4];
cx q[3],q[4];
u3(pi*0.5,pi*0.9147666492,0) q[3];
...
rz(pi*0.5) q[6];
cx q[5],q[6];
u3(pi*0.5,pi*0.9189072392,pi*1.0) q[5];
u3(pi*0.5,pi*1.4189072392,0) q[6];

// Gate: cirq.FSimGate(theta=1.5862983338115253, phi=0.5200148508319427)
u3(pi*1.0,0,pi*1.0) q[8];
u3(pi*1.0,0,pi*1.0) q[9];
rx(pi*0.5) q[8];
cx q[8],q[9];
...
u3(pi*0.9998653312,pi*1.5,pi*0.5) q[10];
u3(pi*0.0001346688,pi*1.5,pi*1.5) q[11];
rx(pi*0.5) q[10];
cx q[10],q[11];
...
rz(pi*0.5) q[11];
cx q[10],q[11];
u3(pi*0.9998653312,pi*0.5,pi*1.5) q[10];
u3(pi*0.0001346688,pi*1.5,pi*1.5) q[11];
...
u3(pi*0.4741322475,pi*1.5,pi*0.5) q[16];
u3(pi*0.4741322475,pi*0.5,pi*0.5) q[17];
rx(pi*0.5) q[16];
cx q[16],q[17];
...
rz(pi*0.5) q[17];
cx q[16],q[17];
u3(pi*0.4741322475,pi*0.5,pi*1.5) q[16];
u3(pi*0.4741322475,pi*0.5,pi*0.5) q[17];
u3(pi*0.6950866205,pi*0.5,0) q[16];
u3(pi*0.3049133795,pi*0.5,pi*1.0) q[17];
rx(pi*0.5) q[16];
cx q[16],q[17];
rx(pi*0.0102867061) q[16];
ry(pi*0.5) q[17];
...
rz(pi*0.5) q[17];
cx q[16],q[17];
u3(pi*0.6950866205,pi*1.0,pi*0.5) q[16];
u3(pi*0.3049133795,pi*2.0,pi*0.5) q[17];
u3(pi*0.5,0,pi*0.9273232623) q[16];
...
rz(pi*0.5) q[17];
cx q[16],q[17];
u3(pi*0.5,pi*1.9884299576,pi*1.0) q[16];
...
u3(pi*0.3237918088,pi*1.5,pi*0.5) q[23];
u3(pi*0.6762081912,pi*0.5,pi*0.5) q[24];
rx(pi*0.5) q[23];
cx q[23],q[24];
...
rz(pi*0.5) q[24];
cx q[23],q[24];
u3(pi*0.3237918088,pi*0.5,pi*1.5) q[23];
u3(pi*0.6762081912,pi*0.5,pi*0.5) q[24];
u3(pi*0.5,pi*0.5,0) q[23];
...
cx q[25],q[26];
u3(pi*1.0,0,0) q[25];
u3(0,pi*1.0,pi*1.0) q[26];
u3(0,0,pi*0.5) q[25];
u3(pi*1.0,0,pi*0.5) q[26];
rx(pi*0.5) q[25];
cx q[25],q[26];
rx(pi*8.11259e-05) q[25];
ry(pi*0.5) q[26];
...
u3(pi*0.5,pi*1.5,pi*1.5) q[27];
u3(pi*0.5,pi*0.5,pi*1.5) q[28];
rx(pi*0.5) q[27];
cx q[27],q[28];
...
cx q[27],q[28];
u3(pi*0.5,pi*1.5,pi*1.5) q[27];
u3(pi*0.5,pi*1.5,pi*0.5) q[28];
u3(pi*0.68598498,pi*1.5,pi*1.0) q[27];
u3(pi*0.31401502,pi*1.5,0) q[28];
rx(pi*0.5) q[27];
cx q[27],q[28];
rx(pi*0.0060860445) q[27];
ry(pi*0.5) q[28];
...
rz(pi*0.5) q[28];
cx q[27],q[28];
u3(pi*0.68598498,0,pi*1.5) q[27];
u3(pi*0.31401502,pi*1.0,pi*1.5) q[28];
...
u3(pi*0.5221287584,pi*0.5,pi*0.5) q[4];
u3(pi*0.5221287584,pi*1.5,pi*0.5) q[5];
rx(pi*0.5) q[4];
cx q[4],q[5];
...
cx q[4],q[5];
u3(pi*0.5221287584,pi*0.5,pi*0.5) q[4];
u3(pi*0.5221287584,pi*0.5,pi*1.5) q[5];
u3(pi*0.8481954371,pi*1.5,0) q[4];
u3(pi*0.8481954371,pi*0.5,0) q[5];
rx(pi*0.5) q[4];
cx q[4],q[5];
rx(pi*0.0020187909) q[4];
ry(pi*0.5) q[5];
...
rz(pi*0.5) q[5];
cx q[4],q[5];
u3(pi*0.8481954371,pi*1.0,pi*1.5) q[4];
u3(pi*0.8481954371,pi*1.0,pi*0.5) q[5];
...
rz(pi*0.5) q[5];
cx q[4],q[5];
u3(pi*0.5,pi*1.9134276993,pi*1.0) q[4];
...
u3(pi*0.0204107577,pi*1.5,pi*1.5) q[13];
u3(pi*0.0204107577,pi*0.5,pi*1.5) q[14];
rx(pi*0.5) q[13];
cx q[13],q[14];
...
cx q[13],q[14];
u3(pi*0.0204107577,pi*1.5,pi*1.5) q[13];
u3(pi*0.0204107577,pi*1.5,pi*0.5) q[14];
u3(pi*0.75,pi*0.5,pi*1.0) q[13];
u3(pi*0.75,pi*1.5,pi*1.0) q[14];
rx(pi*0.5) q[13];
cx q[13],q[14];
rx(pi*0.0181217245) q[13];
ry(pi*0.5) q[14];
...
rz(pi*0.5) q[14];
cx q[13],q[14];
u3(pi*0.75,pi*2.0,pi*0.5) q[13];
u3(pi*0.75,0,pi*1.5) q[14];
...
u3(pi*0.6762081912,pi*0.5,pi*0.5) q[15];
u3(pi*0.6762081912,pi*1.5,pi*1.5) q[16];
rx(pi*0.5) q[15];
cx q[15],q[16];
...
rz(pi*0.5) q[16];
cx q[15],q[16];
u3(pi*0.3237918088,pi*1.5,pi*1.5) q[15];
u3(pi*0.3237918088,pi*0.5,pi*0.5) q[16];
u3(pi*0.5,pi*0.5,0) q[15];
u3(pi*0.5,pi*1.5,pi*1.0) q[16];
rx(pi*0.5) q[15];
cx q[15],q[16];
rx(pi*0.0044947321) q[15];
ry(pi*0.5) q[16];
...
u3(pi*0.5,0,pi*1.5415341879) q[15];
...
rz(pi*0.5) q[16];
cx q[15],q[16];
u3(pi*0.5,pi*1.371971095,pi*1.0) q[15];
...
u3(pi*1.0,0,pi*0.5) q[25];
u3(pi*0.5,pi*1.0,pi*0.1233633886) q[24];
...
rz(pi*0.5) q[25];
cx q[24],q[25];
u3(pi*0.5,pi*0.8030024853,0) q[24];
u3(pi*0.5,pi*1.3030024853,pi*1.0) q[25];

// Gate: cirq.FSimGate(theta=1.4749003996237158, phi=0.4353609222411594)
u3(pi*0.3237918088,pi*0.5,pi*1.5) q[28];
u3(pi*0.3237918088,pi*0.5,pi*0.5) q[29];
rx(pi*0.5) q[28];
cx q[28],q[29];
...
rz(pi*0.5) q[29];
cx q[28],q[29];
u3(pi*0.3237918088,pi*1.5,pi*0.5) q[28];
u3(pi*0.3237918088,pi*0.5,pi*0.5) q[29];
u3(pi*0.5,pi*1.5,0) q[28];
u3(pi*0.5,pi*0.5,0) q[29];
rx(pi*0.5) q[28];
cx q[28],q[29];
rx(pi*0.0305246217) q[28];
ry(pi*0.5) q[29];
...
u3(pi*0.1762081912,pi*0.5,pi*0.5) q[4];
u3(pi*0.1762081912,pi*0.5,pi*1.5) q[9];
rx(pi*0.5) q[4];
cx q[4],q[9];
...
cx q[4],q[9];
u3(pi*0.1762081912,pi*0.5,pi*0.5) q[4];
u3(pi*0.1762081912,pi*1.5,pi*0.5) q[9];
...
rz(pi*0.5) q[20];
cx q[14],q[20];
u3(pi*0.5,pi*0.4169699457,0) q[14];
...
u3(pi*0.6762081912,pi*1.5,pi*1.5) q[23];
u3(pi*0.3237918088,pi*1.5,pi*1.5) q[27];
rx(pi*0.5) q[23];
cx q[23],q[27];
...
rz(pi*0.5) q[27];
cx q[23],q[27];
u3(pi*0.3237918088,pi*0.5,pi*0.5) q[23];
u3(pi*0.6762081912,pi*0.5,pi*0.5) q[27];
u3(pi*0.5,pi*1.5,0) q[23];
u3(pi*0.5,pi*1.5,0) q[27];
rx(pi*0.5) q[23];
cx q[23],q[27];
rx(pi*0.0081328231) q[23];
ry(pi*0.5) q[27];
...
u3(pi*0.5,0,pi*0.0663696586) q[23];
...
rz(pi*0.5) q[27];
cx q[23],q[27];
u3(pi*0.5,pi*0.8523925663,pi*1.0) q[23];
...
cx q[25],q[29];
u3(pi*1.0,0,0) q[25];
u3(0,pi*1.0,pi*1.0) q[29];
u3(0,0,pi*0.5) q[25];
u3(pi*1.0,0,pi*0.5) q[29];
rx(pi*0.5) q[25];
cx q[25],q[29];
rx(pi*0.0590291248) q[25];
ry(pi*0.5) q[29];
...
u3(pi*0.6762081912,pi*0.5,pi*0.5) q[4];
rx(pi*0.5) q[0];
cx q[0],q[4];
...
u3(pi*0.0157699825,pi*0.5,pi*1.5) q[2];
u3(pi*0.0157699825,pi*1.5,pi*1.5) q[6];
rx(pi*0.5) q[2];
cx q[2],q[6];
...
rz(pi*0.5) q[6];
cx q[2],q[6];
u3(pi*0.0157699825,pi*1.5,pi*0.5) q[2];
u3(pi*0.0157699825,pi*1.5,pi*1.5) q[6];
u3(pi*0.8058352756,pi*0.5,0) q[2];
u3(pi*0.1941647244,pi*0.5,pi*1.0) q[6];
rx(pi*0.5) q[2];
cx q[2],q[6];
rx(pi*0.021235342) q[2];
ry(pi*0.5) q[6];
...
rz(pi*0.5) q[6];
cx q[2],q[6];
u3(pi*0.8058352756,pi*1.0,pi*0.5) q[2];
u3(pi*0.1941647244,pi*2.0,pi*0.5) q[6];
...
rz(pi*0.5) q[6];
cx q[2],q[6];
u3(pi*0.5,pi*1.3923863392,pi*1.0) q[2];
...
u3(pi*0.1762081912,pi*0.5,pi*1.5) q[9];
u3(pi*0.1762081912,pi*1.5,pi*0.5) q[15];
rx(pi*0.5) q[9];
cx q[9],q[15];
...
rz(pi*0.5) q[15];
cx q[9],q[15];
u3(pi*0.8237918088,pi*0.5,pi*1.5) q[9];
u3(pi*0.8237918088,pi*1.5,pi*0.5) q[15];
u3(pi*0.5,pi*0.5,0) q[9];
u3(pi*0.5,pi*0.5,0) q[15];
rx(pi*0.5) q[9];
cx q[9],q[15];
...
u3(pi*0.5,0,pi*1.5) q[15];
u3(pi*0.5,0,pi*0.0536265806) q[9];
...
rz(pi*0.5) q[15];
cx q[9],q[15];
u3(pi*0.5,pi*0.8721283731,pi*1.0) q[9];
...
u3(pi*0.5,pi*1.0,pi*0.0278530404) q[10];
...
rz(pi*0.5) q[16];
cx q[10],q[16];
u3(pi*0.5,pi*0.9028525315,0) q[10];
...
u3(pi*0.6762081912,pi*1.5,pi*0.5) q[18];
u3(pi*0.3237918088,pi*0.5,pi*0.5) q[23];
rx(pi*0.5) q[18];
cx q[18],q[23];
...
rz(pi*0.5) q[23];
cx q[18],q[23];
u3(pi*0.6762081912,pi*0.5,pi*1.5) q[18];
u3(pi*0.3237918088,pi*0.5,pi*0.5) q[23];
...
u3(pi*0.9739195266,pi*1.5,pi*0.5) q[19];
u3(pi*0.9739195266,pi*0.5,pi*0.5) q[24];
rx(pi*0.5) q[19];
cx q[19],q[24];
...
rz(pi*0.5) q[24];
cx q[19],q[24];
u3(pi*0.9739195266,pi*0.5,pi*1.5) q[19];
u3(pi*0.9739195266,pi*0.5,pi*0.5) q[24];
u3(pi*0.1954943897,pi*1.5,0) q[19];
u3(pi*0.1954943897,pi*0.5,0) q[24];
rx(pi*0.5) q[19];
cx q[19],q[24];
rx(pi*0.005270413) q[19];
ry(pi*0.5) q[24];
...
rz(pi*0.5) q[24];
cx q[19],q[24];
u3(pi*0.1954943897,pi*1.0,pi*1.5) q[19];
u3(pi*0.1954943897,pi*1.0,pi*0.5) q[24];
u3(pi*0.5,pi*1.0,pi*0.5642914329) q[19];
...
rz(pi*0.5) q[24];
cx q[19],q[24];
u3(pi*0.5,pi*0.3531623046,0) q[19];
...
u3(pi*1.0,0,pi*1.0) q[21];
u3(pi*1.0,0,pi*1.0) q[26];
rx(pi*0.5) q[21];
cx q[21],q[26];
...
u3(pi*0.458462342,pi*0.5,pi*1.5) q[21];
u3(pi*0.458462342,pi*1.5,pi*1.5) q[22];
rx(pi*0.5) q[21];
cx q[21],q[22];
...
rz(pi*0.5) q[22];
cx q[21],q[22];
u3(pi*0.458462342,pi*1.5,pi*0.5) q[21];
u3(pi*0.458462342,pi*1.5,pi*1.5) q[22];
u3(pi*0.3071037501,pi*0.5,pi*1.0) q[21];
u3(pi*0.3071037501,pi*1.5,pi*1.0) q[22];
rx(pi*0.5) q[21];
cx q[21],q[22];
rx(pi*0.0354803847) q[21];
ry(pi*0.5) q[22];
...
rz(pi*0.5) q[22];
cx q[21],q[22];
u3(pi*0.3071037501,0,pi*0.5) q[21];
u3(pi*0.3071037501,pi*2.0,pi*1.5) q[22];
u3(pi*0.5,0,pi*0.25) q[21];
...
u3(pi*0.3237918088,pi*1.5,pi*0.5) q[14];
u3(pi*0.6762081912,pi*0.5,pi*0.5) q[15];
rx(pi*0.5) q[14];
cx q[14],q[15];
...
rz(pi*0.5) q[15];
cx q[14],q[15];
u3(pi*0.3237918088,pi*0.5,pi*1.5) q[14];
u3(pi*0.6762081912,pi*0.5,pi*0.5) q[15];
