...
class Instruction(Operation):
    ...
    def params(self, parameters):
        # FIXME(): remove validation for qdao performance
    ...
    def assemble(self):
        ...
        # Evaluate parameters
        if self.params:
            # FIXME(): in QDAO no need to do so for performance issue
    ...
    def condition_bits(self) -> List[Clbit]:
        ...
        from qiskit.circuit.controlflow import (  # pylint: disable=cyclic-import
            condition_resources,
        )
